    ...
    <div className="space-y-6">
            ...
            <Card key={type}>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm">{enabled}/{count} active</p>
                </div>
              </CardContent>
            </Card>
          )
      ...
      <Tabs defaultValue="gateways">
        <TabsList>
          ...
          <TabsTrigger value="payouts">Tipster Payouts</TabsTrigger>
        </TabsList>

        <TabsContent value="gateways" className="space-y-6 mt-4">
          {loading ? (
            <div className="flex items-center justify-center py-16 text-muted-foreground">
              <RefreshCw className="h-6 w-6 animate-spin mr-2" /> Loading gateways...
            </div>
          ) : (
        ...
        <TabsContent value="payouts" className="mt-4">
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="instant">Instant (on request)</SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">→ Tipster gets</span>
                    <div className="relative w-28">
                      <Percent className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-emerald-500" />
                      <Input
                        readOnly
                        className="pl-9 bg-muted font-bold text-emerald-600"
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium">Allowed Payout Methods</Label>
                <p className="text-xs text-muted-foreground">
                  ...
                  {gateways.filter((g) => g.supportsPayouts).map((gw) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-2 rounded-lg border p-2.5 text-sm text-left transition-colors",
                          selected
                      ...
                      >
                        ...
                        {!gw.enabled && (
                          <Badge variant="outline" className="text-[9px] px-1 ml-auto shrink-0">Inactive</Badge>
                        )}
                      </button>
                    )
                  })}
              ...
              <div className="flex justify-end pt-2">
                <Button onClick={handleSavePayoutSettings} disabled={savingPayout} className="gap-2">
                  {savingPayout ? (
